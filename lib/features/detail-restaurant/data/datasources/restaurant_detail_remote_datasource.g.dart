...
part of 'restaurant_detail_remote_datasource.dart';
...
class _RestaurantDetailRemoteDatasource
  ...
  @override
  Future<AddReviewResponse> addReview(Map<String, String> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
